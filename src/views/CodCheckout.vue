        ...
        <div v-show="!showCity" class="items">
          <li class="relative my-2">
            ...
            <label
              ...
              class="flex p-1 text-sm bg-white cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-green-500 peer-checked:ring-2 peer-checked:border-transparent"
              for="khartoum"
              >الخرطوم</label
            >
          </li>
          ...
          <li class="relative my-2">
            ...
            <label
              style="font-size: 12px"
              class="flex p-1 text-sm bg-white cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-violet-500 peer-checked:ring-2 peer-checked:border-transparent"
              for="omdurman"
              >امدرمان</label
            >
          </li>
      ...
      <div class="address py-2">
        ...
        <div v-show="!showAddr" class="items">
          ...
          >
            ...
            />
            <label
              class="flex p-1 bg-white rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-violet-500 peer-checked:ring-2 peer-checked:border-transparent text-sm"
              :for="item.addr"
